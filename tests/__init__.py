...
from demo.model import User, Article
...
user_one = {'email': 'jiyunshneg66@gmail.com',
            'username': 'yunshengji',
            'password': 'test',
            'level': 1}
admin = {'email': 'caige66@gmail.com',
         'username': 'caige',
         'password': 'test',
         'level': 9}


article_data = {'title': 'test_title',
                'author': 'yunshengji'}
...
class BaseTest():
    ...
    def delete_articles(self):
        ...
        tools.assert_equals(Article.objects().count(), 0)

    @tools.nottest
    def delete_user(self):
        User.objects().delete()
        tools.assert_equals(User.objects().count(), 0)
